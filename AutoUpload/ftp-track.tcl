...
set mysql_(password) "ns?rdsiTas?4at?79HBKQ?TE"
...
set chann_(deletelog) "#LOG"
set chann_(autoup_chan) "#LOG"
set chann_(log_chan) "#LOG"
...
putlog "xxx FTP TRA3K FiSH --> Script v1.58 by sCRiPTzTEAM -- Loaded Succesfully!"