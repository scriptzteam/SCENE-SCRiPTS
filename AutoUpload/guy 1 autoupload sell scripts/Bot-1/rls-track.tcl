...
set chann_(spam) "#A.ann"
set chann_(superspam) "#A.spam"

set chann_(log_chan) "#A.autoup"

set ftpbotnick "A-FTP"
						...
						if {$isdone == "1"} {
							...
							if {$alldone != ""} {
								...
								if {$crdone == "1"} {
									...
									cmdputblow "PRIVMSG $chann_(log_chan) :!complete $category $rlsname"
									cmdputblow "PRIVMSG $chann_(log_chan) :D0NE in $category: -> $rlsname . Sending Create Torrent cmd..."
...
putlog "AutoFTP TRA3K Release FiSH --> Script v1.18 by sCRiPTzTEAM -- Loaded Succesfully!"