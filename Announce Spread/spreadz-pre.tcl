...
bind bot - VIDEOPRE videoprerls
bind bot - MP3PRE mp3prerls

bind bot - IMDB getimdbrls
bind bot - URL geturlrls
...
set prefix_(videoinfo) "\0032ViDE0 iNF0\003"
set prefix_(mp3info) "\0039MP3 iNF0\003"

set prefix_(imdb) "\0034iMDB\003"
set prefix_(url) "\00314URL\003"
...
proc isy:helpme {nick host hand chan arg} {
	...
	putquick "PRIVMSG $chan :$chan powered by irc.example.com & Developed sCRiPTzTEAM"
...
proc getimdbrls {bot com args} {
	...
	if { $bot == $whichinfobot } {	
		...
		set rlsname [lindex [lindex $args 0] 0]
		set rls [isy:highlight_group $rlsname]
		set imdb [lindex [lindex $args 0] 1]
			
		putquick "PRIVMSG $anninfochan :$bopen$prefix_(imdb)$bclose $rls $bopen\00314http:\/\/www.imdb.com\/title\/$imdb\/\003$bclose"
...
proc geturlrls {bot com args} {
	...
	if { $bot == $whichinfobot } {	
		...
		putquick "PRIVMSG $anninfochan :$bopen$prefix_(url)$bclose $rls $bopen\00314$url\003$bclose"
...
proc mp3prerls {bot com args} {
	...
	if { $bot == $whichinfobot } {
		...
		putquick "PRIVMSG $anninfochan :$bopen$prefix_(mp3info)$bclose $rls $bopen\00314Genre:\003 $genre $bdiv \00314Year:\003 $year $bdiv \00314Hertz:\003 $hertz $bdiv \00314Type:\003 $type $bdiv \00314Bitrate:\003 $bitrate $bdiv \00314Format:\003 $bittype$bclose"
...
putlog "xxx-PRE PR3 MP3-ViD Announce & SEARCH --> Script v1.78 by sCRiPTzTEAM -- Loaded Succesfully!"