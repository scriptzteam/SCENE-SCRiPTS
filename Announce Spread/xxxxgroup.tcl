...
proc getinforls {bot com args} {
	...
	if { $bot == $whichinfobot } {
		...
		putquick "PRIVMSG $anninfochan :$bopen$info_prefix$bclose $rlsname $bopen\00314$size\003MB$bdiv\00314$fles\003F$bclose"
...
proc getgenrerls {bot com args} {
	...
	if { $bot == $whichinfobot } {	
		...
		putquick "PRIVMSG $anninfochan :$bopen$genre_prefix$bclose $rlsname $bopen\00314$gnre\003$bclose"
...
putlog "xxx beckklaus --> Script v1.04 by Islander -- Loaded Succesfully!"