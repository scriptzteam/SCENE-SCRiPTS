...
set script_version "xxx ALL v2.12 SCRiPT"
...
proc nfoprerls {bot com args} {
	...
	if { $bot == $whichbot } {	
		...
		putquick "PRIVMSG $chann_(addspam) :!addnfo $rlsname https://example.com/get.php?r=$hash $filename $crc"
...
proc sfvprerls {bot com args} {
	...
	if { $bot == $whichbot } {	
		...
		putquick "PRIVMSG $chann_(addspam) :!addsfv $rlsname https://example.com/get.php?r=$hash $filename $crc"
...
proc m3uprerls {bot com args} {
	...
	if { $bot == $whichbot } {	
		...
		putquick "PRIVMSG $chann_(addspam) :!addm3u $rlsname https://example.com/get.php?r=$hash $filename $crc"
...
proc jpgprerls {bot com args} {
	...
	if { $bot == $whichbot } {	
		...
		putquick "PRIVMSG $chann_(addspam) :!addjpg $rlsname https://example.com/get.php?r=$hash $filename $crc"
...
proc dizprerls {bot com args} {
	...
	if { $bot == $whichbot } {	
		...
		putquick "PRIVMSG $chann_(addspam) :!adddiz $rlsname https://example.com/get.php?r=$hash $filename $crc"
...
putlog "$script_version --> By \002sCRiPTzTEAM\002 ||| Loaded Succesfully!"