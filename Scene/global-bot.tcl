...
set script_version "xxx v1.36 SCRiPT"
...
set chann_(addinfo) "#add"
set chann_(nuke) "#nuke"
set chann_(nuke2) "#nuke"
set chann_(delpre) "#nuke"

set chann_(addmp3) "#info"
set chann_(addvideo) "#info"
set chann_(addurl) "#info"

set chann_(addold) "#addold"

# Set this to your IRC pre announce channels.
set chann_(infoann) "#add"
set chann_(spamann) "#add"
...
proc isy:sectioncolor { arg } {
	...
	array set sectionColors {
			"PSXPSP" 		"\0036PSXPSP\003" 
			"SUBPACK" 		"\0036SUBPACK\003" 
			"NGAGE" 		"\0036NGAGE\003" 
			"SVCD" 			"\0036SVCD\003" 
			"VCD" 			"\0036VCD\003" 
			...
			"MP3" 			"\0036MP3\003" 
			"XXX" 			"\00313XXX\003" 
			"XXX-iMGSETS" 	"\00313XXX-iMGSETS\003" 
			"MVID" 			"\00310MViD\003" 
