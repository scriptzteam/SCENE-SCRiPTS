# SCRiPT v5.15 ADVANC3D ELiT3 SCRiPT
# By Islander :)
package require mysqltcl
package require TclCurl

set script_version "ADD ALL || S3ARCH L33T VERSiON SCRiPT v5.15"
...
#  `size` decimal(9,2) unsigned NOT NULL DEFAULT '0.00',
...
#  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
#  `rel_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
#  `rel_nfo` longtext COLLATE utf8mb4_unicode_ci,
#  `rel_filename` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
#  `rel_time` int(11) unsigned NOT NULL DEFAULT '0',
#  PRIMARY KEY (`id`),
#  UNIQUE KEY `rel_name` (`rel_name`),
#  KEY `rel_time` (`rel_time`)
#) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1;

#CREATE TABLE IF NOT EXISTS `sfv` (
#  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
#  `rel_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
#  `rel_sfv` longtext COLLATE utf8mb4_unicode_ci,
#  `rel_filename` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
#  `rel_time` int(11) unsigned NOT NULL DEFAULT '0',
#  PRIMARY KEY (`id`),
#  UNIQUE KEY `rel_name` (`rel_name`),
...
#  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
#  `rel_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
#  `rel_m3u` longtext COLLATE utf8mb4_unicode_ci,
#  `rel_filename` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
#  `rel_time` int(11) unsigned NOT NULL DEFAULT '0',
#  PRIMARY KEY (`id`),
#  UNIQUE KEY `rel_name` (`rel_name`),
...
#  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
#  `rel_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
#  `rel_jpg` longtext COLLATE utf8mb4_unicode_ci,
#  `rel_filename` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
#  `rel_time` int(11) unsigned NOT NULL DEFAULT '0',
#  PRIMARY KEY (`id`),
#  UNIQUE KEY `rel_name` (`rel_name`),
...
#CREATE TABLE IF NOT EXISTS `diz` (
#  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
#  `rel_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
#  `rel_diz` longtext COLLATE utf8mb4_unicode_ci,
#  `rel_filename` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
#  `rel_time` int(11) unsigned NOT NULL DEFAULT '0',
#  PRIMARY KEY (`id`),
#  UNIQUE KEY `rel_name` (`rel_name`),
	...
	if {[channel get $chan $type]} {
		...
		if {$results != ""} {
            ...
            foreach { rlsname sec time files size genre reason network status nfoid sfvid m3uid jpgid coverid mp3info videoinfo url } $results {
				...
				putquick "PRIVMSG $chan :$bopen$count$bclose $bopen$section$bclose $bopen\00314$rlsname\003$bclose $infod$genred$predago$menuked$nfod$sfvd$m3ud$jpgd$coverd$mp3infod$videoinfod$urld"
...
proc isy:formatpre {rls sect time files size genre nuked reason network nfo sfv m3u jpg cover mp3info videoinfo url} {
	...
	if { $files != "0" && $size != "0" } { set infod "$bopen $filesF in $size MB$bclose " }
...
proc isy:addfile { channel type rlsname url filename } {
	...
	if {[channel get $channel addfiles]} {
		...
		if { $numrel == 0 } {
			...
			set nix [::mysql::exec $db_handle "INSERT INTO $type ( `rel_name` , `rel_$type` , `rel_filename` , `rel_time` ) VALUES ( '[::mysql::escape $db_handle $rlsname]' , COMPRESS('[::mysql::escape $db_handle $data]') , '[::mysql::escape $db_handle $filename]' , '[::mysql::escape $db_handle $unixtime]' )"]
